...
Asset packagers like [django-assetpackager](http://code.google.com/p/django-assetpackager/) use the filesystem as a cache for compiled assets. A twelve-factor app prefers to do this compiling during the [build stage](V%20Build,%20release,%20run%209636ae65a02c4cb6b4450bb8fdf61471.md). Asset packagers such as [Jammit](https://github.com/documentcloud/jammit) and the [Rails asset pipeline](http://ryanbigg.com/guides/asset_pipeline.html) can be configured to package assets during the build stage.
