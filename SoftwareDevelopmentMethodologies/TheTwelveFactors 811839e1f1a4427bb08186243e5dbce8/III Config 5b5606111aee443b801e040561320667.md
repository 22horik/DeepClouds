...
An app’s *config* is everything that is likely to vary between [deploys](I%20Codebase%202b059202958543419888e3e678b44fc5.md) (staging, production, developer environments, etc). This includes:

- Resource handles to the database, Memcached, and other [backing services](IV%20Backing%20services%201c1e72b649f649babc444f5cb9834892.md)
